...
class __TwigTemplate_0d8b880c022e33ee847f77ac7b0a83db extends Template
{
    private $source;
    private $macros = [];
...
echo _gettext("Host");
          ...
          ";
            // line 38
            echo call_user_func_array($this->env->getFilter('notice')->getCallable(), [_gettext("Only replicas started with the --report-host=host_name option are visible in this list.")]);
            echo "
          <br>
        </div>
      </li>
...
";
    ...
    {
        return new Source("", "server/replication/primary_replication.twig", "C:\\WEB\\data\\htdocs\\phpMyAdmin\\templates\\server\\replication\\primary_replication.twig");
    }
}
